                ...
                <div className="row">
                    <div className="col-4">
                        <form className="form-group">
                            ...
                            <div >
                            <small className="text-secondary" <small className="text-secondary">{currencies[baseAcronym].name}</small>>{currencies[baseAcronym].name}</small>
                            </div>
                            <div className="input-group">
                                <div className="input-group-prepend" id="unitAmount">
                                    <label htmlFor="base">Base Unit Amount:</label>
