  ...
  class ToDoList extends React.Component {
    ...
    componentDidMount() {
      ...
      fetchTasks() {
        ...
        fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=76")
          .then(checkStatus)
          .then(json)
          .then((response) => {
    ...
    handleSubmit(event) {
      ...
      deleteTask(id) {
        ...
        fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}?api_key=76`, {
          method: "DELETE",
          mode: "cors",
        }).then(checkStatus)
          .then(json)
      ...
      toggleComplete(id, completed) {
        ...
        fetch(`https://fewd-todolist-api.onrender.com/tasks/${id}/mark_${newState}?api_key=76`, {
          method: "PUT",
          mode: "cors",
        }).then(checkStatus)
          .then(json)
