    ...
    return (
        <React.Fragment>
          <div className="text-center p-3">
            ...
            <h4>1 {baseAcronym} to 1 {quoteAcronym} = {rate.toFixed(4)} {currencies[quoteAcronym]}</h4>
          </div>
          <form className="form-row p-3 mb-4 bg-light justify-content-center">
            <div className="form-group col-md-5 mb-0">
              <select value={baseAcronym} onChange={this.changeBaseAcronym} className="form-control form-control-lg mb-2">
                {currencyOptions}
              </select>
              ...
              <small className="text-secondary">{currencies[baseAcronym]}</small>
            </div>
            ...
            <div className="form-group col-md-5 mb-0">
              ...
              <div className="input-group">
                <div className="input-group-prepend">
                  <div className="input-group-text">{currencies[quoteAcronym]}</div>
                </div>
                <input id="quote" className="form-control form-control-lg" value={quoteValue} onChange={this.changeQuoteValue} type="number" />
              </div>
              <small className="text-secondary">{currencies[quoteAcronym]}</small>
            </div>
          </form>
