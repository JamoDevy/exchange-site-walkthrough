    ...
    return (
        <React.Fragment>
          <div className="text-center p-3">
            ...
            <h4>1 {baseAcronym} to 1 {quoteAcronym} = {rate.toFixed(4)} {currencies.name}</h4>
          </div>
